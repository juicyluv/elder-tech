...
type ServerInterface interface {
	...
	GetCourseMembers(w http.ResponseWriter, r *http.Request, id int64)

	// (POST /courses/{id}/members)
	AddCourseMembers(w http.ResponseWriter, r *http.Request, id int64)
...
// (GET /courses/{id}/members)
func (_ Unimplemented) GetCourseMembers(w http.ResponseWriter, r *http.Request, id int64) {
	w.WriteHeader(http.StatusNotImplemented)
}

// (POST /courses/{id}/members)
func (_ Unimplemented) AddCourseMembers(w http.ResponseWriter, r *http.Request, id int64) {
	w.WriteHeader(http.StatusNotImplemented)
}
